...
public class Cart {
    public ArrayList<TheBook> listBook;//tao gio hang
    ...
    public TheBook getBookfromList(int i){
        ...
        if ( i>=0 && i<listBook.size() ){
            ...
            else System.out.println("Out of books");
        }
        //khong co sach
        return null;
    }
    ...
    public boolean addBookToCart(TheBook book){
    ...
    public void sortbyName(int k){
        ...
        if ( k==0 ){
            Collections.sort(listBook, TheBook::NameTangdan);
        }
        //tu z-a
        else{
            Collections.sort(listBook, TheBook::NameGiamdan);
        }
    }
    ...
    public void sortbyPrice(int k){
        ...
        if ( k==0 ){
            Collections.sort(listBook , TheBook::PriceTangdan);
        }
        //tu lon toi nho
        else{
            Collections.sort(listBook , TheBook::PriceGiamdan);
        }
    }
}
