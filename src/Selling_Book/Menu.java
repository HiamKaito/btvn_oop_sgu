...
public class Menu {
    ...
    //thong tin ve sachTheBook
    public static TheBook a = new TheBook("Alchemist", 10, 10, new String[]{"Paulo Coelho"});
    public static TheBook b = new TheBook("Gris", 20, 1, new String[]{"Conrad Roset"," Nomada Studio"} );
    public static TheBook c = new TheBook("Harry Potter", 100, 7, new String[]{"J. K. Rowling"} );
    public static TheBook d = new TheBook("The Little Prince", 7.99, 3, new String[]{"Antoine De Saint-Exupery"} );    
