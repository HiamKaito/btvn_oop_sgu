...
public class TheBook {
    ...
    public TheBook(String name, double price, int amount, String[] id){
        this.name = name;
        this.price = price;
        this.amount = amount;
        this.id_Authors = id;
    ...
    public static int NameTangdan(TheBook a, TheBook b){
        return a.name.compareTo(b.name);
    }
    
    public static int NameGiamdan(TheBook a, TheBook b){
        return b.name.compareTo(a.name);
    }
    
    public static int PriceTangdan(TheBook a, TheBook b){
        if (a.price < b.price) {
            return -1;
        } 
        else {
    ...
    public static int PriceGiamdan(TheBook a, TheBook b){
        if (a.price > b.price) {
                    return -1;
        } 
        else {
